...
const Places = () => {
  ...
  const getCoverPhoto = (stateid) => {
    switch (stateid) {
      case '0':
        return '/images/ap.jpeg';
      case '1':
        return '/images/arunachalpradesh1.jpg';
      case '2':
        return '/images/assam3.png';
      case '3':
        return '/images/bihar3.jpeg';
      case '4':
        return '/images/chhattisgarh3.jpeg';
      case '5':
        return '/images/goa3.jpg';
      case '6':
        return '/images/gujarat3.jpeg';
      case '7':
        return '/images/haryana3.jpeg';  
      case '8':
        return '/images/himachalpradesh3.jpeg';
      case '9':
        return '/images/jammuandkashmir3.jpeg';
      case '10':
        return '/images/jharkhand3.jpeg';
      case '11':
        return '/images/karnataka3.jpeg';
        case '12':
        return '/images/kerala3.jpg';
        case '13':
        return '/images/madhyapradesh3.png';
        case '14':
        return '/images/maharashtra3.jpeg';
        case '15':
        return '/images/manipur3.jpeg';
        case '16':
        return '/images/meghalaya3.jpeg';
        case '17':
        return '/images/mizoram3.jpeg';
        case '18':
        return '/images/nagaland3.jpeg';
        case '19':
        return '/images/odisha3.jpeg';
        case '20':
        return '/images/punjab3.jpeg';
        case '21':
        return '/images/rajasthan3.jpeg';
        case '22':
        return '/images/sikkim3.png';
        case '23':
        return '/images/tamilnadu3.png';
        case '24':
        return '/images/telangana3.jpeg';
        case '25':
        return '/images/tripura3.jpeg';
        case '26':
        return '/images/uttarpradesh3.jpeg';
        case '27':
        return '/images/uttarakhand3.jpeg';
        case '28':
        return '/images/westbengal3.jpeg';
        case '29':
        return '/images/delhi3.jpeg';
        case '30':
        return '/images/ladakh3.jpeg';
        case '31':
        return '/images/pondicherry3.png';
        case '32':
        return '/images/andaman3.jpeg';
        case '33':
        return '/images/chandigarh3.jpeg';
        case '34':
        return '/images/daman3.jpeg';
        case '35':
        return '/images/lakshadweep3.jpeg';        



            
      // Add more cases for different stateid and corresponding image URLs
      default:
        return '';
    }
  };
...
<h1 className="text-center welcome-heading">Themes You Can Explore</h1>
      ...
      <div className="theme-image">
            <img src="/images/beach-tour.svg" alt="Beach" />
            <h5 style={{color: 'green'}}>BEACH</h5>
        </div>
        <div className="theme-image">
            <img src="/images/pilgrimage-tour.svg" alt="Beach" />
            <h5 style={{color: 'green'}}>PILGRIMAGE</h5>
          </div>
          <div className="theme-image">
            <img src="/images/heritage-tour.svg" alt="Beach" />
            <h5 style={{color: 'green'}}>HERITAGE</h5>
          </div>
          <div className="theme-image">
            <img src="/images/wildlife-tour.svg" alt="Beach" />
            <h5 style={{color: 'green'}}>WILDLIFE</h5>
          </div>
          <div className="theme-image">
            <img src="/images/hillstation-tour.png" alt="Beach" />
            <h5 style={{color: 'green'}}>HILL STATION</h5>
          </div>
    </div>
  ...
  <h1 className="head">
      ...
      <div className="places-container">
        {placesData.map((place, index) => (
          <div
            className={`place-card ${index % 2 === 0 ? 'left' : 'right'} ${index % 5 === 0 ? 'color1' : index % 5 === 1 ? 'color2' : index % 5 === 2 ? 'color3' : index % 5 === 3 ? 'color4' : 'color5'}`}
            key={index}
          >
            ...
            <div className="place-details">
              ...
              <button style={{ margin: '3px', borderRadius: '8px' }}>Famous Food</button>
            </div>
          </div>
        ))}
      </div>
      ...
      <a href="https://example.com" className="highlighted-text">
